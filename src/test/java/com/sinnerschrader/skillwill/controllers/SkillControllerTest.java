...
public class SkillControllerTest {
	...
	public void testAddSkillDuplicateName() {
		assertEquals(HttpStatus.BAD_REQUEST,
			skillController.addSkill("Java", "", false, "", "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar").getStatusCode());
	}

	@Test
	public void testAddSkillEmptyName() {
		assertEquals(HttpStatus.BAD_REQUEST,
			skillController.addSkill("", "", false, "", "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar").getStatusCode());
	}

	@Test
	public void testAddSkillUnprivilegedRole() {
		assertEquals(HttpStatus.FORBIDDEN,
			skillController.addSkill("New Skill", "", false, "Java, hidden skill", "YWFhLmFhYUBleGFtcGxlLmNvbQ==|foo|bar")
				.getStatusCode());
	}
	...
	public void testAddSkillValid() throws JSONException {
		assertEquals(HttpStatus.OK,
			skillController.addSkill("foo", "", false, "", "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar").getStatusCode());
		assertEquals("foo",
			new JSONArray(skillController.getSkills("fo", true, -1).getBody()).getJSONObject(0).getString("name"));
	}

	@Test
	public void testAddSkillWithHiddenSubskill() {
		assertEquals(HttpStatus.OK,
			skillController.addSkill("New Skill", "", false, "Java, hidden skill", "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar")
				.getStatusCode());
	}

	@Test
	public void testAddSkillWithSubskills() {
		assertEquals(HttpStatus.OK, skillController
			.addSkill("New Skill", "", false, "Java, COBOL", "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar").getStatusCode());
	...
	public void testAddSkillWithUnknownSubskill() {
		assertEquals(HttpStatus.BAD_REQUEST,
			skillController
				.addSkill("New Skill", "", false, "Java, COBOL, Wurstwasser", "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar")
				.getStatusCode());
	...
	public void testDeleteEmpty() {
		assertEquals(HttpStatus.NOT_FOUND,
			skillController.deleteSkill("", "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar", null).getStatusCode());
	}
	...
	public void testDeleteMigrate() {
		...
		assertEquals(HttpStatus.OK,
			skillController.deleteSkill("Java", "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar", "COBOL").getStatusCode());
	...
	public void testDeleteMigrateNoSkill() {
		...
		assertEquals(HttpStatus.OK,
			skillController.deleteSkill("COBOL", "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar", "Java").getStatusCode());
	...
	public void testDeleteMigrateTargetNotFound() {
		assertEquals(HttpStatus.NOT_FOUND, skillController
			.deleteSkill("Java", "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar", "Ramalamadingdong").getStatusCode());
	...
	public void testDeleteMigrateToSource() {
		assertEquals(HttpStatus.BAD_REQUEST,
			skillController.deleteSkill("Java", "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar", "Java").getStatusCode());
		assertNotNull(skillRepo.findByName("Java"));
	}
	...
	public void testDeleteUnknown() {
		assertEquals(HttpStatus.NOT_FOUND,
			skillController.deleteSkill("foo", "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar", null).getStatusCode());
	}

	@Test
	public void testDeleteUnprivilegedRole() {
		assertEquals(HttpStatus.FORBIDDEN,
			skillController.deleteSkill("foo", "YWFhLmFhYUBleGFtcGxlLmNvbQ==|foo|bar", null).getStatusCode());
	}

	@Test
	public void testDeleteValid() throws JSONException {
		assertEquals(HttpStatus.OK,
			skillController.deleteSkill("Java", "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar", null).getStatusCode());
	...
	public void testEditNewEmptyString() {
		assertEquals(HttpStatus.OK, skillController
			.updateSkill("Java", "", "", null, null, "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar").getStatusCode());
		assertNotNull(skillRepo.findByName("Java"));
	...
	public void testEditNewExisting() {
		assertEquals(HttpStatus.BAD_REQUEST, skillController
			.updateSkill("Java", "COBOL", "", null, null, "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar").getStatusCode());
		assertNotNull(skillRepo.findByName("Java"));
	}
	...
	public void testEditNewHasSpaceValid() {
		assertEquals(HttpStatus.OK, skillController
			.updateSkill("Java", "Foobar ", "", null, null, "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar").getStatusCode());
	...
	public void testEditNewNull() {
		assertEquals(HttpStatus.OK, skillController
			.updateSkill("Java", null, "", null, null, "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar").getStatusCode());
		assertNotNull(skillRepo.findByName("Java"));
	}
	...
	public void testEditOldEmpty() {
		assertEquals(HttpStatus.NOT_FOUND, skillController
			.updateSkill("", "barfoo", "", null, null, "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar").getStatusCode());
		assertNull(skillRepo.findByName(""));
	...
	public void testEditOldNull() {
		assertEquals(HttpStatus.NOT_FOUND, skillController
			.updateSkill(null, "barfoo", "", null, null, "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar").getStatusCode());
	...
	public void testEditOldUnknown() {
		assertEquals(HttpStatus.NOT_FOUND, skillController
			.updateSkill("foobar", "barfoo", "", null, null, "YmJiLmJiYkBleGFtcGxlLmNvbQ==|foo|bar").getStatusCode());
		assertNull(skillRepo.findByName("barfoo"));
		assertNull(skillRepo.findByName("foobar"));
	}
	...
	public void testEditSkillUnprivileged() {
		assertEquals(HttpStatus.FORBIDDEN, skillController
			.updateSkill("Java", null, "", false, "Rama Lama, Ding Ding, Dong", "useressionkey").getStatusCode());
	}
